...
**When to use:** Complex business domains with rich workflows, when you need detailed behavioural analytics.
...
```python
# Write side - optimised for transactions
...
**When to use:** High-scale systems with very different read/write patterns, when you need to optimise for both throughput and query performance.
...
5. **Keep balance fields** as materialised views for performance
