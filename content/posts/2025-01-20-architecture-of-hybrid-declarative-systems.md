...
Think of a hybrid declarative system like a brain with specialised regions that collaborate:
...
- **Reasoner**: Proof search (Prolog-style) or materialisation (Datalog-style)
...
Use Markov Logic Networks or Probabilistic Soft Logic. Inference optimises agreement with weighted constraints.
