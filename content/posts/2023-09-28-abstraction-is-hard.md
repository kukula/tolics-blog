...
- You can combine behaviours independently
...
- Implementations have fundamentally different behaviours
- You're just trying to make the code "more object-oriented"
- You're modeling real-world relationships instead of software behaviours
