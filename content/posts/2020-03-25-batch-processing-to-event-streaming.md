...
summary: "Moving from batch jobs to an event-driven architecture wasn't just a technical upgrade — it changed the way we thought about systems, risk, and ownership."
