...
When we estimate a feature, we usually think about development time. But the real cost of a feature extends far beyond the initial implementation. This is where [asking the right questions](/posts/hype-vs-pragmatic-development/) becomes crucial — we need to understand the full lifecycle before we commit.
...
- Requires specialised knowledge to maintain
...
- **Integration features:** High maintenance, minimise surface area
